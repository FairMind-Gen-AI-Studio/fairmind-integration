...
allowed-tools: Bash(python3 .claude/scripts/analyze_sonarqube.py), Bash(poetry run pytest:*), Bash(git add:*), Bash(git commit:*), Bash(rm -f sonarqube_report.json), Read, Write, Edit, MultiEdit, Grep, Glob
---
...
Execute: `python3 .claude/scripts/analyze_sonarqube.py`
